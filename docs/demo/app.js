...
function renderLanguage() {
  ...
  byId("lang-en").setAttribute("aria-pressed",String(language === "en"));
  byId("lang-zh").setAttribute("aria-pressed",String(language === "zh"));
...
byId("lang-en").addEventListener("click",() => {language="en";renderLanguage();});
byId("lang-zh").addEventListener("click",() => {language="zh";renderLanguage();});
renderLanguage();
