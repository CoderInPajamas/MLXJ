...
[JEV Ultrafast](https://github.com/browser-use/jev-ultrafast) were reviewed as related
public approaches. No source files or weights from those projects are included.

All application content and evaluation scenarios were written for this project and
are fictional. No FounderOS production data, conversations, audio, screenshots or
logs were imported. Local model weights are external and retain their upstream and
conversion licenses; the Python package does not distribute them.
